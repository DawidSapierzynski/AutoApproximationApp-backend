...
class TrigonometricInterpolationTest {
    ...
    void setUp() {
        ...
        for (int i = 0; i < SIZE; i++) {
            x += ADD;
            evenPoints.add(new PointXY(x, getFunctionValue(x)));
        }
    ...
    void doInterpolationsEven() {
        ...
        resultPolynomial = evenTrigonometricInterpolation.doApproximations();
    ...
    void doInterpolationsOddSize() {
        ...
        resultPolynomial = oddTrigonometricInterpolation.doApproximations();
