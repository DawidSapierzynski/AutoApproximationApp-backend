...
public abstract class TrigonometricApproximationAbstract extends Approximation {
    private final Logger logger = LoggerFactory.getLogger(TrigonometricApproximationAbstract.class);
    ...
    protected abstract Matrix getMatrixA(Matrix matrixX, Matrix matrixY);
    ...
    public List<MathematicalFunction> doApproximations() {
        ...
        matrixA = getMatrixA(matrixX, matrixY);
        ...
        logger.info("Absolute error = {}", calculateError());
